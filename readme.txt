=== WP Activity Log ===
	...
	Tags: Activity Log, Activity, site activity, WP Activity
	...
	What is happening on your site front-end or admin get all activity.

== Description ==

### WP Activity Log by http://paratheme.com
...
2. Go your plugin setting via WordPress Dashboard and find "<strong>WP Activity Log</strong>" activate it.<br />

After activate plugin you will see "WP Activity Log" menu at left side on WordPress dashboard.<br />
